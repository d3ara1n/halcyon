...
- 当前：**竞态矩阵覆盖增强**——执行 `todo-2026-08-28-race-matrix-coverage.md`，补 kill-vs-exit/fault/abandon 的反向时序，使幂等仲裁两侧终因都被真实观察；完成后进入多线程 ThreadSpawn 里程碑。
