...
| 文件 | 概要 |
|---|---|
| [`todo-2026-08-26-process-lifecycle.md`](todo-2026-08-26-process-lifecycle.md) | 下一自然序主线：完整进程生命周期与终止屏障——显式 ProcessKill/JobKill、fixed-width 状态查询、多线程 teardown barrier、调度域 eligibility 后开放 D64。尚未开始实施 |
