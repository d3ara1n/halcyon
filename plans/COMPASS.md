...
| [`todo-2026-09-memory-object-data-plane.md`](todo-2026-09-memory-object-data-plane.md) | 当前主线：平台供给账本、系统储备、strict MemoryPool 与 funded frame broker 已完成；下一步为空壳 ProcessBindMemory → 公共 MemoryObject/多页 Tunnel/Runnel v2 |
