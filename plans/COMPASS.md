...
| [`todo-2026-08-26-process-lifecycle.md`](todo-2026-08-26-process-lifecycle.md) | 下一自然序主线：完整进程生命周期与终止屏障——step 1–9 已实施收口（step 9 多核竞态矩阵：srv_hammer 双锤 10 场景全绿，顺带修复 dealloc_bounded 预算 off-by-one 与 sifive_u 装载窗口）；剩余 step 10：文档终态收口（含 notes 结构整改）；此后首选大项是多线程（ThreadSpawn）里程碑 |
...
| [`todo-2026-08-28-race-matrix-coverage.md`](todo-2026-08-28-race-matrix-coverage.md) | step 9 竞态矩阵的覆盖增强：kill-vs-exit/fault/abandon 补靶先行的时序变体，使幂等仲裁另一侧终因有胜出轮 |
