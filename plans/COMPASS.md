...
| 文件 | 概要 |
|---|---|
| [`todo-2026-09-review-program.md`](todo-2026-09-review-program.md) | 9ee2791 复核已完成；六报告归档，D-1 P2、E-1 新 P1、E-2 新 P2 仍开放，由原报告唯一承接 |
| [`review-2026-09-mechanism-generalization.md`](review-2026-09-mechanism-generalization.md) | D-1 两个 P1 闭合；P2-D1-03 保留精确 Tunnel 失败/交错/守恒证据缺口，已有并发 close 与退出压力不替代该门 |
| [`review-2026-09-system-audit-03-04.md`](review-2026-09-system-audit-03-04.md) | E-1 原 M3 findings 闭合；新 N-1/P1：Ready 前公共 panic/fatal 未广播 Failed，secondary 可永久 Preparing |
| [`review-2026-09-system-audit-05-07.md`](review-2026-09-system-audit-05-07.md) | E-2 原 RPC/lint findings 闭合；E2-7-02/P2：nofd 预期旧日志与 optional-degraded 输出漂移，recipe 假失败 |
...
五份专题实施计划和本轮闭合的 A/B-1/B-2/C-1/C-2/D-2 六份报告位于 `plans/archived/`，入口见 [`Review program`](todo-2026-09-review-program.md)。D-1/E-1/E-2 三份报告在根目录承接开放项；不重开档案或另建重复 todo。
