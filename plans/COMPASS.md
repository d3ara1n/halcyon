...
| [`todo-2026-09-memory-object-data-plane.md`](todo-2026-09-memory-object-data-plane.md) | 切片 8/9 实现与完整验收已完成，提交范围纳入统一架构 Review：多页 Tunnel/owner/RV64 共享访问/RNL2/真实消费者及旧路径删除已贯通；剩余切片 10 为独立库存自检来源收口 |
| [`todo-2026-09-fal-service-capabilities.md`](todo-2026-09-fal-service-capabilities.md) | RNL2 后设计/实施 DirectoryGrant、跨 provider 路由、服务发现、正式 Open 与 Watch；正式 FAL 多页流验收归此，不作为数据面前置 |
