...
| 文件 | 概要 |
|---|---|
| [`todo-2026-09-memory-object-data-plane.md`](todo-2026-09-memory-object-data-plane.md) | A–E 前置已闭合，可恢复切片 8 多页 Tunnel→切片 9 RNL2 与消费者；已登记 RNL1 整数回绕、Endpoint 安全 owner、共享字节访问与门铃握手闭包；切片 10 仍是独立 selftest 来源收口 |
| [`todo-2026-09-monotonic-time-rpc-deadline.md`](todo-2026-09-monotonic-time-rpc-deadline.md) | 有限 RPC timeout 的完整调用语义：先建立公共单调时间 seam，再让投递背压与回复等待消费同一绝对 deadline；正式开放有限时限 RPC 前完成 |
