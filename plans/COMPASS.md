...
| [`todo-2026-09-13-service-runtime-prerequisites.md`](todo-2026-09-13-service-runtime-prerequisites.md) | 当前下一任务，四闭包：消息运输 → 流运输/Runnel → 通用执行/准入 → RPC/Outbox；同步真实消费者，包含 Runnel 终态修复与事件驱动监督 |
