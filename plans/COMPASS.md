...
| [`todo-2026-08-30-user-memory-mapping-review.md`](todo-2026-08-30-user-memory-mapping-review.md) | 未来审查：用户内存切片 1–8B（`1cd6ab2` 至 `bdc83ef`）的统一 AddressSpace、事务失败原子、Remote shootdown、lease/permit/backing 守恒与 ThreadSpawn/join 组合所有权 |
...
| [`todo-2026-09-thread-model.md`](todo-2026-09-thread-model.md) | 当前主线：批一已收口；批二 ThreadSpawn/Exit/Yield、ThreadControl DONE、guarded UserStack/JoinHandle 与 user-memory 8B 已由 `bdc83ef` 提交；批三竞态扩面、carryover IPC 压力线与实现文档同步待做 |
...
- 当前：**ThreadSpawn 批三阶段收尾**——用户内存切片 1–8B 已由 `1cd6ab2` 至 `bdc83ef` 八笔提交完成，实施档案见 [`archived/todo-2026-09-user-memory-mapping.md`](archived/todo-2026-09-user-memory-mapping.md)，未来审查见 [`todo-2026-08-30-user-memory-mapping-review.md`](todo-2026-08-30-user-memory-mapping-review.md)。ThreadSpawn 批二已贯通 shared 固定宽 ABI、Running `Spawning→Ready`、ThreadControl DONE、线程级 Map-result obligation 与 rinlib guarded `UserStack`/结构化 `JoinHandle`；完整平台矩阵 13/13。当前剩余批三：竞态矩阵扩面、carryover IPC 压力线与实现文档同步，计划见 [`todo-2026-09-thread-model.md`](todo-2026-09-thread-model.md)。
