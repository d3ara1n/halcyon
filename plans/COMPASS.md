...
plans/ 根目录保留活跃专题计划与含未闭合 findings 的 Review 报告。专题 todo 拥有当前实施，Review 保留目标提交证据与复核清单，二者不重复安排同一问题；对应关系由 `todo-2026-09-review-program.md` 唯一导航。调查/复核收口后移入 `archived/`，`ref-*` 是只读参考资料。当前全部活跃入口：

| 文件 | 概要 |
|---|---|
| [`todo-2026-09-review-program.md`](todo-2026-09-review-program.md) | 首审已结束；唯一导航 findings 的专题归属、直接前置与复核证据，不按报告次序逐项补丁 |
| [`review-2026-09-memory-transaction-unification.md`](review-2026-09-memory-transaction-unification.md) | A 首审证据与复核清单；事务部分归内存事务计划，EXECUTE 归 capability 计划 |
| [`review-2026-09-memory-supply-and-pool.md`](review-2026-09-memory-supply-and-pool.md) | B-1 首审证据与复核清单；平台输入归 admission，Drop/query 归 owner 错误边界 |
| [`review-2026-09-process-bind-page-table-retire.md`](review-2026-09-process-bind-page-table-retire.md) | B-2 首审证据与复核清单；Bootstrap 提交闭包归构造与启动纵向单元 |
| [`review-2026-09-lifecycle-and-scheduling.md`](review-2026-09-lifecycle-and-scheduling.md) | C-1 首审证据与复核清单；监督、CPU admission、signal 分属对应专题，历史修复不重复实施 |
| [`review-2026-09-remote-call-user-memory.md`](review-2026-09-remote-call-user-memory.md) | C-2 首审证据与复核清单；token/epoch 归 identity，UserStack cleanup 归 owner 错误边界 |
| [`review-2026-09-mechanism-generalization.md`](review-2026-09-mechanism-generalization.md) | D-1 首审证据与复核清单；历史两个 P1 已修，当前 lease 验证随地址空间/Tunnel 纵向迁移 |
...
| [`todo-2026-09-memory-transaction-state-machine.md`](todo-2026-09-memory-transaction-state-machine.md) | 整体完成链施工中：`d453368` 已闭合调度准入，`2884682` 已落命中快照与通知债务施工基线；下一步连接 ThreadDeparture、ProcessDrain、Job/Tunnel/对象退役责任，再接地址空间与构造/Start，切片 8/9 暂停 |
...
| [`todo-2026-09-identity-generation-boundaries.md`](todo-2026-09-identity-generation-boundaries.md) | Token/generation/epoch 身份域与耗尽策略：Remote、Handle、Job、Work-debt、AddressSpace；Ready 使用保活 core 的 affine 准入，不含整数 token 待办 |
| [`todo-2026-08-system-audit.md`](todo-2026-08-system-audit.md) | 系统审计规范与历史分片入口；分片 1–2 已归档，3–7 首审报告已生成并承载后续复核 |
| [`todo-2026-09-memory-object-data-plane.md`](todo-2026-09-memory-object-data-plane.md) | 暂停的数据面能力：切片 8 多页 Tunnel、切片 9 RNL2 与消费者；切片 10 为独立 selftest 来源收口，不是集中清理阶段 |
