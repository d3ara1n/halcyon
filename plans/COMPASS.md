...
| [`todo-2026-09-memory-transaction-state-machine.md`](todo-2026-09-memory-transaction-state-machine.md) | 当前实施：以类型状态机整体收口 MemoryChange/Bootstrap 失败闭包，切片 8/9 暂停；按全局类型/所有权/锁阶纵向迁移，不做局部兼容修复 |
