...
| [`todo-2026-09-memory-transaction-state-machine.md`](todo-2026-09-memory-transaction-state-machine.md) | 地址空间与生命周期机制已完成：调度准入、等待/Finish、ThreadDeparture、MemoryChange、ProcessDrain、Job/Tunnel 退役及构造/Start 原子发布均通过组合压力；暂留以等待 ELF/EXECUTE 独立前置完成联合复核，切片 8/9 继续暂停 |
