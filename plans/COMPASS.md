...
| 文件 | 概要 |
|---|---|
| [`todo-2026-09-memory-object-data-plane.md`](todo-2026-09-memory-object-data-plane.md) | A–E 前置已闭合，可恢复切片 8 多页 Tunnel→切片 9 RNL2 与消费者；切片 10 仍是独立 selftest 来源收口 |
