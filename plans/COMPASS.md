...
| [`todo-2026-09-memory-transaction-state-machine.md`](todo-2026-09-memory-transaction-state-machine.md) | 当前设计收口：地址空间事务、构造与启动发布两个完整纵向单元；冻结来源 owner、存量/在途容量、锁阶与失败模型后再编码，切片 8/9 暂停 |
