...
这些余项恰是切片 7 的地基，拆开实施会为 6E 造只服务匿名的临时投影层再于 7 拆除，因此**已与切片 7 合并**，由 [`archived/todo-2026-09-memory-object-unification.md`](archived/todo-2026-09-memory-object-unification.md) 归档记录，本节与下方切片 7 节不再是实施真值点。
