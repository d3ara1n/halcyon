...
状态：**待独立 review 节点执行**。本文件冻结提交边界、设计契约、审查切片与核证入口，不代表实现已经通过完整 review。应在 `plans/todo-2026-08-26-process-lifecycle.md` 的设计和实施前完成，因为后者直接依赖本次建立的 Job、ProcessBuilder、ProcessControl、进程表与调度发布机制。
